...
!BOP
!
! !ROUTINE: noah33_setwrfexport.F90
!
! !DESCRIPTION:  
...
! 
! !INTERFACE:
subroutine noah33_setwrfexport(n)
! !USES:
  use ESMF
  use LIS_coreMod
...
end subroutine noah33_setwrfexport
