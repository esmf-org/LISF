...
!-----------------------------------------------------------------------------
  ...
  public :: lis_cycle_smootherDA !cycle method for optimization-uncertainty modeling mode
...
!BOP
! !ROUTINE: lis_cycle_smootherDA
!
! !INTERFACE:
  subroutine lis_cycle_smootherDA
! !USES:
    use LIS_coreMod
    use LIS_timeMgrMod
    use LIS_domainMod
...
!EOP
  ...
  end subroutine lis_cycle_smootherDA
